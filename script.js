...
const derniereListe = [
    "- Marouane donne à Téa", 
    "- Teysha donne à Jules", 
    "- Alix donne à Eddy", 
    "- Sofyane donne à Teysha", 
    "- Liam donne à Céleste", 
    "- Jeanne donne à Ilian", 
    "- Lucia donne à Maor", 
    "- Maïa donne à Jeanne", 
    "- Amine donne à Corinne", 
    "- Céleste donne à Maïa", 
    "- Jaime donne à Andrea", 
    "- Kenzi donne à Azir", 
    "- Azir donne à Kenzi", 
    "- Corinne donne à Ramatoulaye", 
    "- Ferdinand donne à Anaïs", 
    "- Ramatoulaye donne à Raphaëlle", 
    "- Ilian donne à Deniz", 
    "- Raphaëlle donne à Marouane", 
    "- Simon donne à Sofyane", 
    "- Eddy donne à Charles", 
    "- Jules donne à Simon", 
    "- Aimee donne à Ferdinand", 
    "- Andrea donne à Jaime", 
    "- Mael donne à Alix", 
    "- Téa donne à Liam", 
    "- Charles donne à Aimee", 
    "- Deniz donne à Meena", 
    "- Raphael donne à Lucia", 
    "- Andrija donne à Amine", 
    "- Maor donne à Mael", 
    "- Anaïs donne à Andrija", 
    "- Meena donne à Raphael"
]